...
<body>
  <div class="row">
    ...
    <h3 class="text-center" style="background-color:#AEC3AE; color:#435334; padding:5px;">User Login</h3>
        ...
        <div class="form-group">
        <input type="submit" name="userLogin" value="Login" class="btn btn-warning l-btn" style="background-color:#435334; color:white;">
        </div><br>
        </form>
